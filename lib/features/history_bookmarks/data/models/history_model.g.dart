...
void _historySerialize(
  ...
  writer.writeDateTime(offsets[3], object.visitedAt);
}
...
History _historyDeserialize(
  ...
  object.visitedAt = reader.readDateTime(offsets[3]);
  return object;
}
...
extension HistoryQueryWhereSort on QueryBuilder<History, History, QWhere> {
  ...
  QueryBuilder<History, History, QAfterWhere> anyVisitedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension HistoryQueryWhere on QueryBuilder<History, History, QWhereClause> {
  ...
  QueryBuilder<History, History, QAfterWhereClause> urlEqualTo(String url) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<History, History, QAfterWhereClause> urlNotEqualTo(String url) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<History, History, QAfterWhereClause> visitedAtEqualTo(
      DateTime visitedAt) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<History, History, QAfterWhereClause> visitedAtNotEqualTo(
      DateTime visitedAt) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<History, History, QAfterWhereClause> visitedAtGreaterThan(
    DateTime visitedAt, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<History, History, QAfterWhereClause> visitedAtLessThan(
    DateTime visitedAt, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<History, History, QAfterWhereClause> visitedAtBetween(
...
extension HistoryQueryFilter
  ...
  QueryBuilder<History, History, QAfterFilterCondition> faviconUrlIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<History, History, QAfterFilterCondition> faviconUrlIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<History, History, QAfterFilterCondition> faviconUrlEqualTo(
    String? value, {
  ...
  QueryBuilder<History, History, QAfterFilterCondition> faviconUrlGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<History, History, QAfterFilterCondition> faviconUrlLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<History, History, QAfterFilterCondition> faviconUrlBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<History, History, QAfterFilterCondition> faviconUrlStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<History, History, QAfterFilterCondition> faviconUrlEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<History, History, QAfterFilterCondition> faviconUrlContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<History, History, QAfterFilterCondition> faviconUrlMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<History, History, QAfterFilterCondition> faviconUrlIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'faviconUrl',
        value: '',
  ...
  QueryBuilder<History, History, QAfterFilterCondition> faviconUrlIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'faviconUrl',
        value: '',
  ...
  QueryBuilder<History, History, QAfterFilterCondition> visitedAtEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<History, History, QAfterFilterCondition> visitedAtGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<History, History, QAfterFilterCondition> visitedAtLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<History, History, QAfterFilterCondition> visitedAtBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension HistoryQuerySortBy on QueryBuilder<History, History, QSortBy> {
  QueryBuilder<History, History, QAfterSortBy> sortByFaviconUrl() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'faviconUrl', Sort.asc);
    });
  }

  QueryBuilder<History, History, QAfterSortBy> sortByFaviconUrlDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<History, History, QAfterSortBy> sortByVisitedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'visitedAt', Sort.asc);
    });
  }

  QueryBuilder<History, History, QAfterSortBy> sortByVisitedAtDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension HistoryQuerySortThenBy
  ...
  QueryBuilder<History, History, QAfterSortBy> thenByFaviconUrl() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'faviconUrl', Sort.asc);
    });
  }

  QueryBuilder<History, History, QAfterSortBy> thenByFaviconUrlDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'faviconUrl', Sort.desc);
    });
  }
  ...
  QueryBuilder<History, History, QAfterSortBy> thenByVisitedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'visitedAt', Sort.asc);
    });
  }

  QueryBuilder<History, History, QAfterSortBy> thenByVisitedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'visitedAt', Sort.desc);
    });
  }
...
extension HistoryQueryWhereDistinct
  ...
  QueryBuilder<History, History, QDistinct> distinctByFaviconUrl(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<History, History, QDistinct> distinctByVisitedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension HistoryQueryProperty
  ...
  QueryBuilder<History, String?, QQueryOperations> faviconUrlProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<History, DateTime, QQueryOperations> visitedAtProperty() {
    return QueryBuilder.apply(this, (query) {
